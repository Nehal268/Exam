...
const addRecipe = async (req, res) => {
  try {
    ...
    const newRecipe = new Recipe({ title, description, ingredients, instructions, imageUrl, cookingTime, createdBy });
...
const updateRecipe = async (req, res) => {
  try {
    const { id } = req.params;
    const { title, description, ingredients, instructions, imageUrl, cookingTime } = req.body;
    const updatedRecipeData = { title, description, ingredients, instructions, imageUrl, cookingTime };
