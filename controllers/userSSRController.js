...
const postSignup = async (req, res) => {
  const { email, password, firstName, lastName, phoneNumber, role, age } = req.body;

  try {
    const user = await User.signup(email, password, firstName, lastName, phoneNumber, role, age);
